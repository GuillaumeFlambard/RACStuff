<?php /* Smarty version Smarty-3.1.13, created on 2013-05-31 11:19:42
         compiled from "C:\Users\SUPINTERNET\Dropbox\SocialClub\SiteWeb\templates\interface.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3083551a86981f33108-61919129%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e0de33c091fa98c8883ab273fc15daf1fd672ee' => 
    array (
      0 => 'C:\\Users\\SUPINTERNET\\Dropbox\\SocialClub\\SiteWeb\\templates\\interface.tpl',
      1 => 1369991954,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3083551a86981f33108-61919129',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_51a86982059a41_96106344',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51a86982059a41_96106344')) {function content_51a86982059a41_96106344($_smarty_tpl) {?>	<div id="statuts_content">
	</div>	
	...
	function listLastPictures() {
		$.getJSON('index.php?action=getLastPictures&ajax', function(tableau) {					
			...
			for (var i = 0; i < length; i++) 
			{
				...
				path = tableau[1][i];
				legend = tableau[2][i];
				$('#photos').append('<div class="legende_part_1"><img src="users/'+login+'/photo_profil/'+login+'.jpg" class="icone_identifiant_1" width="30" height="30"><div class="statut_pseudo_legende">'+login+'</div></div><div class="clear"></div><div id="curseur" class="infobulle"></div><div class="image_galerie"><div class="carousel"><ul><a href="'+path+'" rel="lightbox[photos]" title="'+legend+'"><li><img onmouseover="montre(\''+legend+'\');" onmouseout="cache();" src="'+path+'" alt="Photos: image de l\'ami" height="250"></li></a></ul></div></div>');
			}
