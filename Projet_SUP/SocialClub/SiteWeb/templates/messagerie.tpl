	...
	<div id="conversation_content">
		...
		<div id="reponse">
			<form id="ajax_form" method="post" action="index.php?action=sendResponse">
				<table>
					<tr><td><img src="./images/user_moustache.jpg" id="icone_identifiant_1" width="30" height="30"><input type="text" id="UserRecipient" name="UserRecipient" value="{$interlocuteur}" placeholder="pseudo de votre ami" maxlength="25"></td></tr>
