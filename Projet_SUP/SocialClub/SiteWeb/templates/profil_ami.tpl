	<div id="left_part">
		<div id="description_content">
			<div id="pseudo_profil">{$friend}</div>
			<div id="photo_profil">
				<img src="users/{$friend}/photo_profil/{$friend}.jpg" width="380">
			</div>
...
<script>
	...
	function listImages() {
		$.getJSON('index.php?action=getAllPicturesOfFriend&ajax&pseudo={$friend}', function(tableau)
		{				
	...
	function listFriendsOfFriend(){			//fonction qui va lister tous les amis dans la div correspondante
		$.getJSON('index.php?action=getAllFriendsOfFriend&ajax&pseudo={$friend}', function(friends) {					
	...
	{
		$.getJSON('index.php?action=getConversationProfil&friend={$friend}&ajax', function(tableau)
		{
	...
	{
		$.getJSON('index.php?action=GetPostAmi&ajax&pseudo={$friend}', function(tableau)
		{
			var length = tableau[0].length;
